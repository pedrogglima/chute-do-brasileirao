...
if [[ ! -f /usr/share/nginx/certificates/fullchain.pem ]]; then
    ...
    "/C=PT/ST=World/L=World/O=${DOMAIN:-chutedobrasileirao.com.br}/OU=chutedobrasileirao lda/CN=${DOMAIN:-chutedobrasileirao.com.br}/EMAIL=${EMAIL:-pedrogglima@gmail.com.br}"
