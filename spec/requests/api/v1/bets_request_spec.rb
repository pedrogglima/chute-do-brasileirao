  ...
  setup_api do
    describe 'non-loggers' do
      ...
      it 'returns 401 (#new)' do
        get new_api_v1_match_bet_path(match_id: match.id, format: :json),
            xhr: true,
      ...
      it 'returns 401 (#show)' do
        get api_v1_match_bet_path(bet, match_id: match.id, format: :json),
            xhr: true,
            headers: invalid_token
        expect(response).to(have_http_status(401))
      end
    ...
    describe 'logger users' do
      ...
      describe '#create' do
        context 'valid params' do
          subject do
            post api_v1_bets_path(params: { bet: valid_params }, format: :json),
                 xhr: true,
                 headers: @token
          end
        ...
        context 'invalid params' do
          subject do
            post api_v1_bets_path(
              params: { bet: invalid_params },
              format: :json
            ),
                 xhr: true,
                 headers: @token
